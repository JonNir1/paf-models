...
mu <- c(
  ...
  B = B_BASELINE_MU,
  B_SearchDifficultyMIXED = B_SEARCH_MIX_MU, B_SearchDifficultyDIFFICULT = B_SEARCH_DIF_MU,
...
Sigma <- c(
  ...
  # B, A, t0 are in log scale
  B = B_BASELINE_SD,
  B_SearchDifficultyMIXED = B_SEARCH_MIX_SD, B_SearchDifficultyDIFFICULT = B_SEARCH_DIF_SD,
