...
#' IMPORTANT NOTE: DO NOT USE THIS MODEL
#' THIS MODEL IS MECHANISTICALLY IDENTICAL TO MODEL 4
#' because model 3 uses the interaction only term `StimulusAtLoc:SearchDifficulty`,
#' it needs to evaluate the parameters for the baseline StimulusAtLoc (T):
#' `v_StimulusAtLocT:SearchDifficultyMIXED` and `v_StimulusAtLocT:SearchDifficultyDIFFICULT`
#' when fitting, this is identical to model 4's main-effect parameters:
#' `v_SearchDifficultyMIXED` and `v_SearchDifficultyDIFFICULT`
...
mu <- c(
  ...
  # "v_StimulusAtLocT:SearchDifficultyMIXED" =  # NOTE: need to specify this for identifiability
  ...
  # "v_StimulusAtLocT:SearchDifficultyDIFFICULT" =  # NOTE: need to specify this for identifiability
