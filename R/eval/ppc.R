...
#'   B. Choice proportions -- target / easy distractor / difficult distractor
#'      fractions: predicted vs observed by cue_size and search_difficulty
#'   C. QPF overlays       -- 10/25/50/75/90th-percentile RT by condition:
#'      predicted ribbon (90% CI) vs observed points
#'
#' All computation lives in R/eval/helpers/ppc.R; figures in helpers/plot.R.
...
message("Per-model FDR pass fraction (AD test):")
print(fdr_summary)
